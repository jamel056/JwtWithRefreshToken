using JwtWithRefreshToken.Entities;
using JwtWithRefreshToken.Entities.Data;
using JwtWithRefreshToken.Enums;
using JwtWithRefreshToken.Models;
using JwtWithRefreshToken.Requests;
...
namespace JwtWithRefreshToken.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager,
            IOptions<JWTModel> jwt, ApplicationDbContext context)
        {
        ...
        public async Task<string> RegisterAsync(RegisterModel model)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(user, Seed.default_role.ToString());
                }
